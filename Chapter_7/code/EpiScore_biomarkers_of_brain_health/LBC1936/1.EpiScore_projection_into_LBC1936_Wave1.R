...
# Filter to wave 1
dat3 <- target %>% filter(WAVE == "1") # 1331 people

# Filter to LBC36
dat3  <- dat3 %>% filter(cohort == "LBC36") # 895 people 
...
#loop for calculating episcores
...
## Save file 
write.csv(out_final, "KORA_EpiScores_projected_in_LBC1936_WAVE1_17072023.csv")