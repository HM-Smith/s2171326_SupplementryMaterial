...
#fixed negative resdiual variances 
Sspantot ~~ 0*Sspantot
Sdigback ~~ 0*Sdigback
Smatreas ~~ 0*Smatreas
...
'
 ...
 write.csv(results, paste0(i, "_G_intercept_No_Domain_LBC1936_assocs_84_EpiScores_basic_17072023.csv"), row.names = F)
...
'
  ...
  write.csv(results, paste0(i, "_G_slope_No_Domain_LBC1936_assocs_84_EpiScores_basic_17072023.csv"), row.names = F)
