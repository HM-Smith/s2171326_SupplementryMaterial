...
Brain <- read.csv("Totalbrain_slope_LBC1936_assocs_84_EpiScores_basic_15092023.csv")
GM <- read.csv("GreyMatter_slope_LBC1936_assocs_84_EpiScores_basic_15092023.csv")
NAWM <- read.csv("NAWM_slope_LBC1936_assocs_84_EpiScores_basic_15092023.csv")
WMH <- read.csv("WMH_slope_LBC1936_assocs_84_EpiScores_basic_15092023.csv")
...
write.csv(Brain, file = "Totalbrain_slope_LBC1936_assocs_84_EpiScores_with_ids_basic_20092023.csv")
write.csv(GM, file = "GreyMatter_slope_LBC1936_assocs_84_EpiScores_with_ids_basic_20092023.csv")
write.csv(NAWM, file = "NAWM_slope_LBC1936_assocs_84_EpiScores_with_ids_basic_20092023.csv")
write.csv(WMH, file = "WMH_slope_LBC1936_assocs_84_EpiScores_with_ids_basic_20092023.csv")

write.csv(Brain_nom, file = "Totalbrain_slope_LBC1936_assocs_84_EpiScores_nominally_sig_basic_20092023.csv")
write.csv(GM_nom, file = "GreyMatter_slope_LBC1936_assocs_84_EpiScores_nominally_sig_basic_20092023.csv" )
write.csv(NAWM_nom, file = "NAWM_slope_LBC1936_assocs_84_EpiScores_nominally_sig_basic_20092023.csv")
write.csv(WMH_nom, file = "WMH_slope_LBC1936_assocs_84_EpiScores_nominally_sig_basic_20092023.csv")
