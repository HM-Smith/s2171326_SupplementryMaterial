...
G_intercept_LBC1921 <- read.csv("G_intercept_No_Domain_LBC1921_assocs_84_EpiScores_basic_model_21042023.csv")
G_slope_LBC1921<- read.csv("G_slope_No_Domain_LBC1921_assocs_84_EpiScores_basic_model_21042023.csv")
...
#save out results
write.csv(G_intercept_LBC1921, file = "G_intercept_No_Domain_LBC1921_assocs_84_EpiScores_with_ids_basic_model_21042023.csv")
write.csv(G_slope_LBC1921, file = "G_slope_No_Domain_LBC1921_assocs_84_EpiScores_with_ids_basic_model_21042023.csv")

write.csv(G_intercept_LBC1921_FDR_sig, file = "G_intercept_No_Domain_LBC1921_assocs_84_EpiScores_FDR_sig_basic_model_21042023.csv")

write.csv(G_intercept_LBC1921_nom_sig, file = "G_intercept_No_Domain_LBC1921_assocs_84_EpiScores_Nominally_sig_basic_model_21042023.csv")
write.csv(G_slope_LBC1921_nom_sig, file = "G_slope_No_Domain_LBC1921_assocs_84_EpiScores_Nominally_sig_basic_model_21042023.csv" )