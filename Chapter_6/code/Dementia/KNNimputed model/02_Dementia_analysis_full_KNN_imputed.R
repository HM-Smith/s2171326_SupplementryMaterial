...
#check for individuals with negative tte for dementia 
...
covars <- read.csv("covars_for_dementia_post_outlier_removal_KNNimputed.csv")

names(covars)[23] <- "Sample_Name"
...
write.csv(results, file = "Dementia_GS_MS_prots_KNN_Imputed_coxme.csv")