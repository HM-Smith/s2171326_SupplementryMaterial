...
write.csv(all_covar, file = "omic_covariance.csv")

#set upper and lover variance limit
all_covar$lower <- all_covar$Covariances - all_covar$Covariances_var
all_covar$upper <- all_covar$Covariances + all_covar$Covariances_var
