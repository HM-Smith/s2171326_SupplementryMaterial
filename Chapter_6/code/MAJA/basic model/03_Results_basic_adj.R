...
prot_id <- readRDS("GS_MS_prots_MAJA_cog_adPRS_cogPRS_age_sex_kinship_corrected.rds")
...
names(var) <- c( "digit_symbol", "verbal_total", "vocabulary","LM", "AD_PRS", "cog_PRS")
...
table(sig$Significance, sig$Trait)

#                    AD PRS cognitive PRS digit symbol logical memory
# Non significant     10             3            5              6
# Significant          6            13           11             10
# 
...
write.csv(joined_df, "GS_four_cog_tests_ADPRS_cogPRS_MAJA_all_age_sex_related_adj_results_check.csv") 
write.csv(sig, "GS_four_cog_tests_ADPRS_cogPRS_MAJA_sig_age_sex_related_adj_results.csv") 
