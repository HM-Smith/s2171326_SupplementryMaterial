...
prot_id <- readRDS("GS_MS_prots_MAJA_cog_adPRS_cogPRS_KNNIMPUTE_corrected.rds")
...
write.csv(joined_df, "GS_four_cog_tests_ADPRS_cogPRS_MAJA_KNN_imputed_fully_adj_results.csv") 
write.csv(sig, "GS_four_cog_tests_ADPRS_cogPRS_MAJA_sig_KNN_imputed_fully_adj_results.csv") 
